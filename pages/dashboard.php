    ...
    <div class="whole-dashboard">
                        ...
                        <li>
                            <a href="?page=manage_books"
                               ...
                               data-page="manage_books">
                                <i class="fa-solid fa-book-circle-arrow-right"></i> Manage Books
                            </a>
                        </li>
                        <li>
        ...
        <div class="main-content">
            ...
            <div id="page-borrow_requests" class="page-section<?= $activePage === 'borrow_requests' ? ' active' : '' ?>">
                ...
                <h2 style="font-family:'DM Serif Display',serif;font-size:1.5rem;margin-bottom:20px;">Borrow Requests</h2>
